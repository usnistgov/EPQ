...
public class TextUtilities {
   ...
   public static String wrapHTMLHeader(String name, String content, String css) {
      final String header = "<html>\n" + "<head>\n"
            ...
            + " <meta name=\"GENERATOR\" content=\"DTSA-II\">" + " <meta name=\"description\" content=\"" + name + "\">"
            + " <title>" + name + "</title>"
            + (css != null ? " <link href=\"" + css + "\" rel=\"stylesheet\" type=\"text/css\">\n" : "") + "</head>\n<body>\n";
      return header + content + "\n</body>\n</html>";
   }

   private static final String[][] mHTMLMap = {
      {
         "&amp;",
         "\u0026"
      },
