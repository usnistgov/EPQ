...
public class Translate2DTest
   ...
   public void test1() {
      final Translate2D t2d = new Translate2D();
      {
         ...
         pts.add(Translate2D.createCalibrationPoint(new double[] {
            0.0,
            0.0
         }, new double[] {
            1.395,
      ...
      {
         final double[] r = t2d.inverse(t2d.compute(new double[] {
            0.0,
            0.0
         }));
   ...
   public void test2() {
      ...
      final Translate2D t2d = new Translate2D(new double[] {
         2.0,
         -3.0
      }, new double[] {
         1.0,
      ...
      final double[] r = t2d.compute(new double[] {
         1.0,
         4.0
      });
