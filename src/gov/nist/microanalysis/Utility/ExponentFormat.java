...
public class ExponentFormat
   ...
   /**
    * @param arg0 number
    * @param arg1 output buffer
    * @param arg2 current position
    * @return StringBuffer
   ...
   public StringBuffer format(double arg0, StringBuffer arg1, FieldPosition arg2) {
      ...
      final String tmp = "<nobr>"
            + (sign + (exp != 0 ? mFormatter.format(Math.pow(10.0, la - exp)) + FMT1 + Integer.toString(exp) + FMT2
                  : mFormatter.format(Math.pow(10.0, la - exp))))
            + "</nobr>";
