...
final public class XRayTransition
   implements Comparable<XRayTransition>, Cloneable {

   private static final String[] mTransitionNames = {
      "K\u03B11",
      "K\u03B12",
      "K\u03B21",
      "K\u03B22",
   ...
   private static final int[] mSourceShell = {
      AtomicShell.LIII,
      AtomicShell.LII,
      AtomicShell.MIII,
      AtomicShell.NIII, // KB2 (also NII)
      AtomicShell.MII,
      AtomicShell.NV,
      AtomicShell.MV,
      AtomicShell.NII,
      AtomicShell.NIII,
      AtomicShell.OII, // L3O2
      AtomicShell.OIII,
      AtomicShell.PI,
      AtomicShell.MV,
      AtomicShell.MIV,
      ...
      AtomicShell.NVI,
      AtomicShell.NIII,
      AtomicShell.NVI, // N4N6
      AtomicShell.NVI
   // N5N6 (also NVII)
   };

   private static final int[] mDestinationShell = {
      AtomicShell.K,
      AtomicShell.K,
      AtomicShell.K,
      AtomicShell.K,
      ...
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII, // L3O3
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII, // LB5 (also OV)
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII,
      AtomicShell.LIII, // Lu (also NVII)
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII, // L2O2
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII,
      AtomicShell.LII,
      ...
      AtomicShell.MIII,
      AtomicShell.MIII,
      AtomicShell.MIII, // M3N1
      AtomicShell.MIII,
      AtomicShell.MIII,
      AtomicShell.MIII,
      AtomicShell.MIII,
      AtomicShell.MIII,
      AtomicShell.MIV, // M4N3
      AtomicShell.MIV,
      AtomicShell.MIV,
      AtomicShell.MIV,
      AtomicShell.MV,
   ...
   public XRayTransition(Element el, int trans) {
      ...
      mTransition = trans;
      mSource = new AtomicShell(el, mSourceShell[trans]);
    ...
    * (srcShell)
    * 
    * @param dest AtomicShell - The inner most shell involved in the transition.
   ...
   public int getSourceShell() {
      return mTransition == Unnamed ? mSource.getShell() : mSourceShell[mTransition];
   }
   ...
   static public String getIUPACName(int xrt) {
      return xrt != Unnamed ? AtomicShell.getIUPACName(getDestinationShell(xrt)) + "-"
            + AtomicShell.getIUPACName(getSourceShell(xrt)) : "Unnamed";
   }
    ...
    * @throws EPQException
    */
   public static double getEnergy(Element el, int trans)
         throws EPQException {
      ...
      if(isWellKnown(mTransition)) {
         ...
         switch(mode) {
            ...
            case NormalizeFamily:
               return (mWeight[ani] != null) && (mTransition < mWeight[ani].length) ? mWeight[ani][mTransition]
                     / mFamNormalization[ani][mDestination.getFamily() - AtomicShell.KFamily] : 0.0;
            case NormalizeDestination:
               return (mWeight[ani] != null) && (mTransition < mWeight[ani].length) ? mWeight[ani][mTransition]
                     / mDestNormalization[ani][mDestination.getShell() - AtomicShell.K] : 0.0;
            case NormalizeKLM:
               return (mWeight[ani] != null) && (mTransition < mWeight[ani].length) ? mWeight[ani][mTransition]
                     / mKLMNormalization[ani][mDestination.getFamily() - AtomicShell.KFamily] : 0.0;
         }
      }
      return 0.0;
   }
   ...
   static public double getWeight(Element el, int trans, int mode) {
      ...
      if(isWellKnown(trans)) {
         ...
         switch(mode) {
            ...
            case NormalizeFamily:
               return (mWeight[ani] != null) && (trans < mWeight[ani].length) ? mWeight[ani][trans]
                     / mFamNormalization[ani][XRayTransition.getFamily(trans) - AtomicShell.KFamily] : 0.0;
            case NormalizeDestination:
               return (mWeight[ani] != null) && (trans < mWeight[ani].length) ? mWeight[ani][trans]
                     / mDestNormalization[ani][XRayTransition.getDestinationShell(trans) - AtomicShell.K] : 0.0;
            case NormalizeKLM:
               return (mWeight[ani] != null) && (trans < mWeight[ani].length) ? mWeight[ani][trans]
                     / mKLMNormalization[ani][XRayTransition.getFamily(trans) - AtomicShell.KFamily] : 0.0;
         }
      }
      return 0.0;
   }
