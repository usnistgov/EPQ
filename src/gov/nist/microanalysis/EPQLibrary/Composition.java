...
public class Composition
   ...
   /**
    * Returns a set of elements for which the mass fraction is greater than min
    * and less than max. This is useful because getElementSet() will return
    * elements for which the mass fraction is zero if the uncertainty is
    * non-zero.
    *
    * @param min
    * @param max
   ...
   /**
    * defineByMaterialFraction - Define a new material out of certain fractions
   ...
   /**
    * Like equals except it does not require exact equality. The compositions
   ...
   public void forceNormalization() {
      ...
      for(final Map.Entry<Element, UncertainValue2> me : mConstituents.entrySet())
         newConst.put(me.getKey(), norm.doubleValue() > 0.0 ? UncertainValue2.divide(me.getValue(), norm)
   ...
   static public Composition combine(String name, Map<Composition, UncertainValue2> constituents) {
      ...
      for(final Map.Entry<Composition, UncertainValue2> me : constituents.entrySet()) {
         ...
         for(final Element elm : cc.getElementSet())
            res.addElement(elm, UncertainValue2.add(res.weightFractionU(elm, false), UncertainValue2.multiply(cc.weightFractionU(elm, false), me.getValue())));
      }
      res.setName(name);
      return res;
   }
