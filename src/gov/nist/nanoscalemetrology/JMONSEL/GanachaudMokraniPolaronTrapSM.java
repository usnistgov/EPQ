...
public class GanachaudMokraniPolaronTrapSM extends ScatterMechanism {
	...
	/**
	 * Constructs a GanachaudMokraniPolaronTrapSM. The scatter rate for an electron
	 * obeys an exponential law: rate = prefactor*exp(-extinction*energy), where
	 * energy is the electron's kinetic energy and the other variables are
	 * parameters.
	 *
	...
	/**
	 * @param pe
	 * @return Always returns null because this process does not produce secondary
	 *         electrons.
	...
	public String toString() {
		return "GanachaudMokraniPolaronTrapSM(" + Double.valueOf(prefactor).toString() + ","
				+ Double.valueOf(extinction).toString() + ")";
	}
}
