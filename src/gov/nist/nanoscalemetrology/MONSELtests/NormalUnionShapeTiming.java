...
public class NormalUnionShapeTiming {
   ...
   public static double timetest(long repeats) {
      ...
      @SuppressWarnings("unused")
      final NormalShape altunion = new NormalComplementShape(new NormalIntersectionShape(new NormalComplementShape(substrate), new NormalComplementShape(sphere)));
       ...
       * 2. }; result = altunion.getFirstNormal(pos0, pos1); } tint =
       * System.currentTimeMillis(); for(long i = 0; i < repeats; i++) { pos0 =
       * pos1; pos1 = new double[] { Math.random() * 4. - 2., Math.random() * 4.
       * - 2., Math.random() * 4. - 2. }; } tf = System.currentTimeMillis();
       * deltat = 1000.*(2.*tint-tf-t0)/repeats; return deltat;
       */
       ...
       * for(long i = 0; i < repeats; i++) { pos0 = pos1; pos1 = new double[] {
       * Math.random() * 4. - 2., Math.random() * 4. - 2., Math.random() * 4. -
       * 2 }; result = sum.getFirstNormal(pos0, pos1); } tint =
       * System.currentTimeMillis(); for(long i = 0; i < repeats; i++) { pos0 =
       * pos1; pos1 = new double[] { Math.random() * 4. - 2., Math.random() * 4.
       * - 2., Math.random() * 4. - 2 }; } tf = System.currentTimeMillis();
       * deltat = 1000.*(2.*tint-tf-t0)/repeats; return deltat;
       ...
       * for(long i = 0; i < repeats; i++) { pos0 = pos1; pos1 = new double[] {
       * Math.random() * 4. - 2., Math.random() * 4. - 2., Math.random() * 4. -
       * 2 }; result1 = sum.getFirstIntersection(pos0, pos1); } tint =
       * System.currentTimeMillis(); for(long i = 0; i < repeats; i++) { pos0 =
       * pos1; pos1 = new double[] { Math.random() * 4. - 2., Math.random() * 4.
       * - 2., Math.random() * 4. - 2 }; } // Compute the elapsed time tf =
       * System.currentTimeMillis(); // Stop the "stopwatch" deltat =
       * 1000.*(2.*tint-tf-t0)/repeats; //Time per op in microseconds return
       * deltat;
       */
       ...
       * for(long i = 0; i < repeats; i++) { pos0 = pos1; pos1 = new double[] {
       * Math.random() * 4. - 2., Math.random() * 4. - 2., Math.random() * 4. -
       * 2 }; List<MonteCarloSS.Shape> shapes = union.getShapes(); NormalShape
       * shapeA = (NormalShape) shapes.get(0); NormalShape shapeB =
       * (NormalShape) shapes.get(1); } tint = System.currentTimeMillis();
       * for(long i = 0; i < repeats; i++) { pos0 = pos1; pos1 = new double[] {
       * Math.random() * 4. - 2., Math.random() * 4. - 2., Math.random() * 4. -
       * 2 }; } // Compute the elapsed time tf = System.currentTimeMillis(); //
       * Stop the "stopwatch" deltat = 1000.*(2.*tint-tf-t0)/repeats; //Time per
       * op in microseconds return deltat;
       */
   }
