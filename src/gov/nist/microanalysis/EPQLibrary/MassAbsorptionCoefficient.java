...
abstract public class MassAbsorptionCoefficient
   extends
   AlgorithmClass {
    ...
    * @throws EPQException
    */
   public double meanFreePath(Material mat, XRayTransition xrt)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public double meanFreePath(Material mat, double energy)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public double meanFreePath(Material mat, Element elm, double energy)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public UncertainValue2 computeWithUncertaintyEstimate(Element el, XRayTransition xrt)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public UncertainValue2 computeWithUncertaintyEstimate(Composition comp, XRayTransition xrt)
         throws EPQException {
    ...
    * @return Fractional error estimate 0.0 to &gt;1.0
    */
   public double fractionalUncertainty(Composition comp, XRayTransition xrt)
         throws EPQException {
    ...
    * @return Fractional error estimate 0.0 to &gt;1.0
    */
   public double fractionalUncertainty(Element el, XRayTransition xrt)
         throws EPQException {
   ...
   public UncertaintySource uncertaintySource(Element el, double energy) {
      ...
      if(eV < 200.0) {
         ...
         res = new UncertaintySource(UncertaintyReason.Below500eV, AtomicShell.NoShell, 0.5
               + (((1.0 - 0.5) * (eV - 200)) / (500.0 - 200.0)));
      } else if(eV < 1000) {
         err = 0.05 + (((0.20 - 0.05) * (eV - 500)) / (1000.0 - 500.0));
         res = new UncertaintySource(UncertaintyReason.Below1000eV, AtomicShell.NoShell, 0.05
               + (((0.20 - 0.05) * (eV - 500)) / (1000.0 - 500.0)));
      }
      for(int sh = AtomicShell.K; sh <= AtomicShell.NVII; ++sh)
         if(AtomicShell.exists(el, sh)) {
            final double ee = AtomicShell.getEdgeEnergy(el, sh);
    ...
    */
   public double compute(Element el, XRayTransition xrt)
         throws EPQException {
    ...
    */
   final public double compute(Composition comp, XRayTransition xrt)
         throws EPQException {
      double mac = 0.0;
      for(final Element el : comp.getElementSet())
      ...
      for(int sh = AtomicShell.K; sh < AtomicShell.NVII; ++sh)
         if(AtomicShell.exists(el, sh)) {
            ...
            if(Math.abs(shell.getEdgeEnergy() - energy) < ToSI.keV(0.2))
               res = CaveatBase.append(res, "The transition at " + FromSI.keV(energy) + " is close to the " + shell.toString()
                     + " at " + FromSI.keV(shell.getEdgeEnergy()) + " keV.");
         }
      return res;
   }
    ...
    */
   public static class Ruste79MassAbsorptionCoefficient
      extends
      ...
      ElementTabulation mCarbon = new ElementTabulation(Element.C, AtomicShell.KFamily, new int[] {
         Element.elmB,
         Element.elmC,
         Element.elmSi,
         Element.elmTi,
      ...
      @Override
      final public double compute(Element el, XRayTransition xrt)
            throws EPQException {
   ...
   public static class Pouchou1991MassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      ElementTabulation mBoron = new ElementTabulation(Element.B, AtomicShell.KFamily, new int[] {
         Element.elmB,
         Element.elmC,
         Element.elmN,
         Element.elmO,
      ...
      ElementTabulation mNitrogen = new ElementTabulation(Element.N, AtomicShell.KFamily, new int[] {
         Element.elmB,
         Element.elmN,
         Element.elmAl,
         Element.elmSi,
      ...
      private final int[] mKas = {
         XRayTransition.KA1,
         XRayTransition.KA2
      }; // sorted

      private final int[] mLas = {
         XRayTransition.LA1,
         XRayTransition.LA2
      }; // sorted

      private final int[] mLbs = {
         XRayTransition.LB15,
         XRayTransition.LB2,
         XRayTransition.LB5,
         XRayTransition.LB6,
    ...
    */
   public static class PouchouPichoir88MassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      public PouchouPichoir88MassAbsorptionCoefficient() {
         super("Pouchou & Pichoir 1988", "J. L. Pouchou and F. M. A. Pichoir, 'Determination of Mass Absorption Coefficients for Soft X-Rays by use of the Electron Microprobe' Microbeam Analysis, Ed. D. E. Newbury, San Francisco Press, 1988, p. 319-324");
      }
      ...
      ElementTabulation mAluminum = new ElementTabulation(Element.Al, AtomicShell.KFamily, new int[] {
         Element.elmAl,
         Element.elmCu
      }, new double[] {
         393,
      ...
      ElementTabulation mSilicon = new ElementTabulation(Element.Si, AtomicShell.KFamily, new int[] {
         Element.elmSi,
         Element.elmTa
      }, new double[] {
         356,
      ...
      ElementTabulation mSulfur = new ElementTabulation(Element.S, AtomicShell.KFamily, new int[] {
         Element.elmAu,
         Element.elmHg
      }, new double[] {
         2200,
      ...
      ElementTabulation mCopper = new ElementTabulation(Element.Cu, AtomicShell.LFamily, new int[] {
         Element.elmAl,
         Element.elmNi,
         Element.elmCu
      }, new double[] {
    ...
    */
   public static class Henke82MassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      ElementTabulation mBoronK = new ElementTabulation(Element.B, AtomicShell.KFamily, new int[] {
         Element.elmB,
         Element.elmC,
         Element.elmN,
         Element.elmAl,
      ...
      ElementTabulation mCarbonK = new ElementTabulation(Element.C, AtomicShell.KFamily, new int[] {
         Element.elmB,
         Element.elmC,
         Element.elmSi,
         Element.elmTi,
      ...
      ElementTabulation mNitrogenK = new ElementTabulation(Element.N, AtomicShell.KFamily, new int[] {
         Element.elmMo
      }, new double[] {
         20200
      });

      ElementTabulation mOxygenK = new ElementTabulation(Element.O, AtomicShell.KFamily, new int[] {
         Element.elmLi,
         Element.elmB,
         Element.elmO,
         Element.elmMg,
      ...
      ElementTabulation mAluminumK = new ElementTabulation(Element.Al, AtomicShell.KFamily, new int[] {
         Element.elmAl,
         Element.elmCu
      }, new double[] {
         403,
      ...
      ElementTabulation mSiliconK = new ElementTabulation(Element.Si, AtomicShell.KFamily, new int[] {
         Element.elmSi,
         Element.elmTa
      }, new double[] {
         350,
      ...
      ElementTabulation mCopperL = new ElementTabulation(Element.Cu, AtomicShell.LFamily, new int[] {
         Element.elmAl,
         Element.elmNi
      }, new double[] {
         1450,
      ...
      ElementTabulation mZincL = new ElementTabulation(Element.Zn, AtomicShell.LFamily, new int[] {
         Element.elmZn
      }, new double[] {
         1550
      });

      ElementTabulation mGermaniumL = new ElementTabulation(Element.Ge, AtomicShell.LFamily, new int[] {
         Element.elmGe
      }, new double[] {
         1260
      });

      ElementTabulation mNiobiumL = new ElementTabulation(Element.Nb, AtomicShell.LFamily, new int[] {
         Element.elmNb
      }, new double[] {
         726
      });

      ElementTabulation mMolybdenumL = new ElementTabulation(Element.Mo, AtomicShell.LFamily, new int[] {
         Element.elmAu
      }, new double[] {
         3680
      });
    ...
    * ed.
    */
   public static class BastinHeijligers89MassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      ElementTabulation mOxygen = new ElementTabulation(Element.O, AtomicShell.KFamily, new int[] {
         Element.elmLi,
         Element.elmB,
         Element.elmO,
         Element.elmMg,
      ...
      final public double compute(Element el, double energy) {
         ...
         if(energy > eeK) { // energy is above the K edge.
            ...
            if(energy > eeLIII) {
               ...
               cc = -0.0924e-3 + (z
                     * (0.141478e-3 + (z * (-0.00524999e-3 + (z * (9.85296E-8 + (z * (-9.07306E-10 + (z * 3.19245E-12)))))))));
      ...
      public String caveat(Element el, double energy) {
         ...
         for(int sh = AtomicShell.K; sh < AtomicShell.NVII; ++sh) {
            ...
            if((energy > (ee - ToSI.eV(5.0))) && (energy < (ee + ToSI.eV(20))))
               res = CaveatBase.append(res, "The transition at " + nf.format(FromSI.eV(energy)) + " eV is close to the "
                     + el.toAbbrev() + " " + AtomicShell.getIUPACName(sh) + " edge at " + nf.format(FromSI.eV(ee)) + " eV.");
         }
    ...
    * proceedings.
    */
   public static class Heinrich86MassAbsorptionCoefficient
      extends
      HeinrichBase {
   ...
   public static class HeinrichDtsaMassAbsorptionCoefficient
      extends
      HeinrichBase {
   ...
   public static class HeinrichAltMassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      public double compute(Element el, double energy) {
         ...
         if(energy > EnDat[0]) { /* energy is above the K edge. */
            if(z < 6) {
               ...
               cc = 1.0E-5
                     * ((((525.3 + (133.257 * z)) - (7.5937 * z * z)) + (0.169357 * z * z * z)) - (0.0013975 * z * z * z * z));
               az = ((((-0.152624 * z) + 6.52) * z) + 47) * z;
               nm = 3.112 - (0.0121 * z);
    ...
    * </p>
    */
   public static class ChantlerMassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      public double compute(Element el, double energy) {
         ...
         }
         {
            ...
            if(c < -1) {
               ...
               return Math.exp(Math.log(rM[c1 - 1])
                     + (Math.log(rM[c1] / rM[c1 - 1]) * (Math.log(energy / rE[c1 - 1]) / Math.log(rE[c1] / rE[c1 - 1]))));
    ...
    * DTSA application.
    */
   public static class DTSACitzafMassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      private final String[] mFilenames = {
         "CitMAC/MAC_K_Data.csv",
         "CitMAC/MAC_L_Data.csv",
    ...
    * Null - No absorption
    */
   public static class NullMassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
    ...
    * @version 1.0
    */
   static public class UserSpecifiedCoefficient
      extends
      MassAbsorptionCoefficient {
       ...
       * @throws EPQException
       */
      public void put(Element elm, XRayTransition xrt, double mac)
            throws EPQException {
    ...
    * @version 1.0
    */
   public static class Henke93MassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
      ...
      private void loadElement(Element elm) {
         try {
            synchronized(this) {
               final InputStream is = MassAbsorptionCoefficient.class.getResourceAsStream("Henke93/"
                     + elm.toAbbrev().toLowerCase() + ".nff");
      ...
      public double compute(Element el, double energy) {
         ...
         if(c <= -1) {
            final int c1 = -(c + 1); // Between c1 and c1-1
            if(c1 < muA.length)
               return Math.exp(Math.log(muA[c1 - 1])
                     + (Math.log(muA[c1] / muA[c1 - 1]) * (Math.log(energy / e[c1 - 1]) / Math.log(e[c1] / e[c1 - 1]))));
            else
               return 0.0;
         } else
    ...
    * @version 1.0
    */
   public static class SuperSetMassAbsorptionCoefficient
      extends
      MassAbsorptionCoefficient {
   ...
   static private final AlgorithmClass[] mAllImplementations = {
      ...
      MassAbsorptionCoefficient.HeinrichAlt,
      ...
      MassAbsorptionCoefficient.SuperSet
   };
}
