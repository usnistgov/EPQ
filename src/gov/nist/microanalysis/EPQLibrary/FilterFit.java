...
public class FilterFit
   ...
   private double mResidualModelThreshold = 1.0e3;
   ...
   private static class FilteredPacket {
      ...
      private ROISpectrum mRoiSpectrum;
      ...
      public ISpectrumData getROISpectrum(final double modelThresh) {
         if((mRoiSpectrum == null) || (mRoiSpectrum.getModelThreshold() != modelThresh)) {
            mRoiSpectrum = new ROISpectrum(mFiltered.getBaseSpectrum(), mFiltered.getRegionOfInterest());
            mRoiSpectrum.setModelThreshold(modelThresh);
         }
         return mRoiSpectrum;
      }
      ...
      private double getCounts() {
         if(Double.isNaN(mIntegral)) {
            ...
            mIntegral = SpectrumUtils.backgroundCorrectedIntegral(mFiltered.getBaseSpectrum(), FromSI.eV(roi.lowEnergy()), FromSI.eV(roi.highEnergy()))[0];
         }
         return mIntegral;
      }
   }
    ...
    */
   public FilterFit(final EDSDetector det, final double beamEnergy)
         throws EPQException {
         ...
         while(repeat) {
            ...
            for(int i = 0; i < mFilteredPackets.size(); ++i) {
               ...
               if(!isZeroFitCoefficient(i))
                  intervals = Interval.add(intervals, Interval.nonZeroInterval(raf.getFiltered().getFilteredData()));
            }
    ...
    */
   public void addReference(final Element elm, final ISpectrumData ref)
         throws EPQException {
    ...
    * @param ref
    */
   public void addReference(final RegionOfInterest roi, final ISpectrumData ref)
         throws EPQException {
    ...
    */
   @Override
   public KRatioSet getKRatios(final ISpectrumData unk)
         throws EPQException {
      updateUnknown(unk);
    ...
    * @throws EPQException
    */
   public double getFitMetric(final ISpectrumData unk)
         throws EPQException {
      updateUnknown(unk);
    ...
    * @return ISpectrumData
    */
   public ISpectrumData getResidualSpectrum(final ISpectrumData unk)
         throws EPQException {
      updateUnknown(unk);
      ...
      if(unkProps.isDefined(SpectrumProperties.FaradayBegin))
         props.setNumericProperty(SpectrumProperties.FaradayBegin, unkProps.getNumericWithDefault(SpectrumProperties.FaradayBegin, Double.NaN));
      if(unkProps.isDefined(SpectrumProperties.FaradayEnd))
         props.setNumericProperty(SpectrumProperties.FaradayEnd, unkProps.getNumericWithDefault(SpectrumProperties.FaradayEnd, Double.NaN));
    ...
    * @throws EPQException
    */
   public ISpectrumData getResidualSpectrum(final ISpectrumData unk, Set<Element> elms)
         throws EPQException {
      updateUnknown(unk);
      final SpectrumMath res = new SpectrumMath(mFilteredUnknown.getBaseSpectrum());
      for(final FilteredPacket raf : mFilteredPackets) {
      ...
      if(unkProps.isDefined(SpectrumProperties.AcquisitionTime))
         props.setTimestampProperty(SpectrumProperties.AcquisitionTime, unkProps.getTimestampWithDefault(SpectrumProperties.AcquisitionTime, new Date()));
      if(unkProps.isDefined(SpectrumProperties.LiveTime))
         props.setNumericProperty(SpectrumProperties.LiveTime, unkProps.getNumericWithDefault(SpectrumProperties.LiveTime, Double.NaN));
      if(unkProps.isDefined(SpectrumProperties.RealTime))
         props.setNumericProperty(SpectrumProperties.RealTime, unkProps.getNumericWithDefault(SpectrumProperties.RealTime, Double.NaN));
    ...
    * @throws EPQException
    */
   public double getFitEventCount(final ISpectrumData unk, final Set<Element> exclude)
         throws EPQException {
      updateUnknown(unk);
      double res = 0.0;
      for(final FilteredPacket raf : mFilteredPackets) {
   ...
   private void updateUnknown(final ISpectrumData unk)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public ISpectrumData getFilteredResidual(final ISpectrumData unk)
         throws EPQException {
      updateUnknown(unk);
    ...
    * @version 1.0
    */
   public static class CullByVariance
      implements
      CullingStrategy {
    ...
    * @version 1.0
    */
   public static class CullWithinFamily
      implements
      CullingStrategy {

      static private final int[] mLines = {
         XRayTransition.KA1, // 0
    ...
    * @version 1.0
    */
   public static class CullByFamilies
      implements
      CullingStrategy {
   ...
   public static class CullByAverageUncertainty
      implements
      CullingStrategy {
    ...
    * @version 1.0
    */
   public static class CullByBrightest
      implements
      CullingStrategy {
    ...
    * @version 1.0
    */
   public static class SpecialCulling
      implements
      CullingStrategy {
    ...
    * @version 1.0
    */
   public static class CompoundCullingStrategy
      implements
      CullingStrategy {
