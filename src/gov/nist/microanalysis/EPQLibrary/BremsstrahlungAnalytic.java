...
abstract public class BremsstrahlungAnalytic extends AlgorithmClass {
   ...
   public static class NoBremsstrahlung extends BremsstrahlungAnalytic {
   ...
   public static class Small1987 extends BremsstrahlungAnalytic {
   ...
   public static class Small1987alt extends BremsstrahlungAnalytic {
   ...
   public static class Castellano2004aBremsstrahlung
      ...
      @Override
      public double compute(double eNu) {
         final double ek = FromSI.keV(eNu), e0k = mE0keV;
         double res = 0.0;
         final Riveros1993 riv = new Riveros1993(mComposition, ToSI.keV(mE0keV), mTakeOffAngle);
         if ((ek > 0.050) && (ek < e0k)) {
    ...
    * @version 1.0
    */
   public static class Reed1975 extends BremsstrahlungAnalytic {
    ...
    * @version 1.0
    */
   public static class DTSAQuadratic extends QuadraticBremsstrahlung {
    ...
    * @version 1.0
    */
   public static class Lifshin1974Model extends QuadraticBremsstrahlung {
    ...
    * @param det
    * @param flux
    *           - probe flux in nA*sec / 10 eV window
    */
    ...
    * 
    * @param det
    *           The detector on which the spectrum was collected
    * @param spec
    *           The spectrum to fit
    * @param rois
    *           A collection of int[2] objects defining the background region to
    *           fit (as channels)
    ...
    *           The spectrum to fit
    * @param comp
    *           The composition of the material for the spectrum
    * @param xrts
    *           The set of x-ray transitions about which to fit the background
    ...
    * 
    * @param det
    *           An EDSDectector on which the spectrum was collected
    * @param spec
    *           The spectrum
    * @param comp
    *           The composition of the material represented by the spectrum
    * @param rois
    *           Some region of interests
