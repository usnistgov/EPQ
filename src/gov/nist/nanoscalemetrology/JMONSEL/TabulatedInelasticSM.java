 ...
 * @version 1.0
 */
public class TabulatedInelasticSM extends ScatterMechanism {
	...
	public Electron scatter(Electron pe) {
		 ...
		 * commenting it though I keep it here as a place-marker. My thinking is that
		 * pe.getPreviousEnergy() should return the energy at the end of the last step.
		 * In takeStep(), that energy has already been stored as the previous energy,
		 * when takeStep() took account of any CSD energy loss. Any new energy loss in
		 * the current routine should simply reduce the current energy, so that
		 * pe.getEnergy()-pe.getPreviousEnergy() should reflect the total energy loss
		 * this step, CSD + inelastic mechanisms combined.
		 */
