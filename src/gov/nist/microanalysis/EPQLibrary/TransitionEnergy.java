...
abstract public class TransitionEnergy extends AlgorithmClass {
   ...
   public static class Deslattes2005TransitionEnergy extends TransitionEnergy {
      ...
      public Deslattes2005TransitionEnergy() {
         super("Deslattes et al (2005)", "R.D. Deslattes, E.G. Kessler Jr., P. Indelicato, L. de Billy, E. Lindroth, "
               ...
               + "vailable: http://physics.nist.gov/XrayTrans [2009, May 22]. " + "National Institute of Standards and Technology, Gaithersburg, MD");
      }
   ...
   public static class Chantler2005TransitionEnergy extends TransitionEnergy {
      ...
      @Override
      public boolean isSupported(XRayTransition xrt) {
         return EdgeEnergy.Chantler2005.isSupported(xrt.getSource()) && EdgeEnergy.Chantler2005.isSupported(xrt.getDestination());
      }
   }
   ...
   /**
    * I modeled this on Chantler2005TransitionEnergy but it doesn't work as
    * well. It seems that the edge energies in Chantler aren't consistent with
    * other tabulations but if you use them to calculate trnsition energies, the
    * transition energies are quite accurate. On the other hand, the William's
    * edge energies are more consistent with other tabulations but the
    * transition energies calculated using them are not consistent with other
    * tabulations.
    * 
    * @author nritchie
    *
   ...
   public static class Williams2011TransitionEnergy extends TransitionEnergy {
      public Williams2011TransitionEnergy() {
         super("Williams-2011", "Derived from edge energies taken from Williams 2011 in CRC Physics & Chemistry Handbook");
      }
      ...
      @Override
      public boolean isSupported(XRayTransition xrt) {
         return EdgeEnergy.Williams2011.isSupported(xrt.getSource()) && EdgeEnergy.Williams2011.isSupported(xrt.getDestination());
      }
   }
   ...
   public static class DTSATransitionEnergy extends TransitionEnergy {
      ...
      public boolean isSupported(XRayTransition xrt) {
         ...
         return XRayTransition.isWellKnown(xrt.getTransitionIndex()) && (z >= Element.elmH) && ((z - 1) < mEnergy.length) && (mEnergy[z - 1] != null);
      }
