...
abstract public class Fluorescence
    ...
    * @throws EPQException
    */
   public double lengthScale(Material mat, XRayTransition primary)
         throws EPQException {
    ...
    * @param sh AtomicShell - The destination shell for the x-ray transition
    *           being excited
   ...
   public int primaryExcitingLine(Element el, AtomicShell sh) {
      ...
      for(int tr = XRayTransition.KA1; tr <= XRayTransition.MZ2; ++tr)
         try {
            if((XRayTransition.getEnergy(el, tr) > ee) && (XRayTransition.getFamily(tr) >= bestFam)) {
                  ...
                  if(primXrt.getEnergy() < (shEE + delta))
                     try {
                        ...
                        for(int tr = XRayTransition.KA1; tr <= XRayTransition.MZ2; ++tr)
                           ...
                           if((XRayTransition.getFamily(tr) == primFam) && (XRayTransition.getEnergy(el, tr) >= shEE)
    ...
    * @param secondary XRayTransition - The transition which is being fluoresced
    *           by xrtB
    ...
    */
   public static class NullFluorescence
      extends Fluorescence {
   ...
   public static class MCFluorescence
      extends Fluorescence {
      ...
      public double compute(Composition comp, XRayTransition primary, XRayTransition secondary, double e0, double takeOff) {
         ...
         try {
            ...
            if(pE > secondary.getEdgeEnergy()) {
               ...
               final CorrectionAlgorithm.PhiRhoZAlgorithm prz = (CorrectionAlgorithm.PhiRhoZAlgorithm) getAlgorithm(CorrectionAlgorithm.PhiRhoZAlgorithm.class);
   ...
   public static class ReedFluorescence
      extends Fluorescence {
   ...
   public static class Reed1990Fluorescence
      extends Fluorescence {
