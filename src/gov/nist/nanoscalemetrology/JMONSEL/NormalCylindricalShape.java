 ...
 * @version 1.0
 */
public class NormalCylindricalShape
   extends CylindricalShape
   ...
   public double[] getFirstNormal(double[] pos0, double[] pos1) {
      ...
      switch(intersectionnumber) {
         ...
         case 4:
            ...
            final double normalvmag = Math.sqrt((normalv[0] * normalv[0]) + (normalv[1] * normalv[1])
                  + (normalv[2] * normalv[2]));
