...
public class RippleFile
    ...
    * 
    * @param width - The width of each row (# of columns) within the Ripple file
    * @param height - The number of rows
    * @param depth - The number of data items at each [row,col] position
    * @param dataType - One of RippleFile.SIGNED, RippleFile.UNSIGNED or
    *           RippleFile.FLOAT
    * @param byteDepth - 1, 2, 4 for SIGNED or UNSIGNED, 4 or 8 for FLOAT
    * @param order - BIG_ENDIAN, LITTLE_ENDIAN or DONT_CARE_ENDIAN
    * @param rplFile - File name (usually *.rpl)
    * @param rawFile - File name (usually *.raw)
    * @throws IOException
    */
   ...
   private static String findRaw(String rplFile)
    ...
    * thrown.
    * 
    * @param rplFile The name of the Ripple header file
    * @param readOnly Should the file be opened as read-only?
    * @throws Exception
    * @throws IOException
    * @throws FileNotFoundException
    */
   public RippleFile(String rplFile, boolean readOnly)
         throws Exception,
         IOException,
    ...
    * 
    * @param rplFile The name of the Ripple header file
    * @param rawFile The name of the raw file
    * @param readOnly Should the file be opened as read-only?
    * @throws Exception
    * @throws IOException
    * @throws FileNotFoundException
    */
   public RippleFile(String rplFile, String rawFile, boolean readOnly)
         throws Exception,
         IOException,
         FileNotFoundException {
      super();
    ...
    * @throws IOException
    */
   public void seek(long row, long col, long item)
         throws IOException {
      assert row >= 0;
      assert row < mHeight;
      assert col >= 0;
    ...
    * @throws IOException
    */
   public void setPosition(int x, int y, int item)
         throws IOException {
      seek(y, x, item);
   }
   ...
   public void layersToTIFF(String fn, long begin, long end, boolean fixZero)
         throws IOException {
      ...
      for(int x = 0; x < layer.length; ++x)
         for(int y = 0; y < layer[x].length; ++y) {
            final int gray = fixZero ? Math2.bound((int) (256.0 * (layer[x][y] / max)), 0, 256)
