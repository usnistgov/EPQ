...
public class SpectrumProperties
    ...
    */
   static public class PropertyId
      implements
      Comparable<PropertyId> {
      ...
      public PropertyId(PropertyId base, int index) {
         mName = MessageFormat.format(base.mName, new Object[] {
   ...
   /**
    * FaradayEnd - A measurement of the full probe current taken after the
    * spectrum was acquired.","nA)
    */
   ...
   private static Map<String, PropertyId> createPredefinedPropertyMap() {
      ...
      final PropertyId[] contents = new PropertyId[] {
         SpectrumIndex,
         SpecimenName,
         SpectrumDisplayName,
         SpecimenDesc,
   ...
   public static List<PropertyId> WINDOW_PROPERTIES = Arrays.asList(new PropertyId[] {
      WindowType,
      DiamondWindow,
      MylarWindow,
      BoronNitrideWindow,
   ...
   private static List<PropertyId> DETECTOR_PROPERTIES = Arrays.asList(new PropertyId[] {
      Azimuth,
      Elevation,
      DetectorArea,
      DetectorThickness,
   ...
   public Object getObjectProperty(PropertyId pid)
         throws EPQException {
      final Object res = findProperty(pid);
      if(res == null)
    ...
    * @return String
    */
   public String getTextProperty(PropertyId pid)
         throws EPQException {
    ...
    * @return String
    */
   public String getTextProperty_NoUnit(PropertyId pid)
         throws EPQException {
      final Object res = getObjectProperty(pid);
      switch(pid.getPropertyType()) {
         case Textual:
    ...
    * @return double
    */
   public double getNumericProperty(PropertyId pid)
         throws EPQException {
      final Object res = getObjectProperty(pid);
    ...
    * @throws EPQException
    */
   public double[] getArrayProperty(PropertyId pid)
         throws EPQException {
   ...
   public KRatioSet getKRatioProperty(PropertyId pid)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public Image getImageProperty(PropertyId pid)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public Composition getCompositionProperty(PropertyId pid)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public ParticleSignature getParticleSignatureProperty(PropertyId pid)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public SampleShape getSampleShapeProperty(PropertyId pid)
         throws EPQException {
    ...
    * @return boolean
    */
   public boolean getBooleanProperty(PropertyId pid)
         throws EPQException {
      final Object res = getObjectProperty(pid);
    ...
    * @throws EPQException
    */
   public Date getTimestampProperty(PropertyId pid)
         throws EPQException {
      final Object res = getObjectProperty(pid);
    ...
    * @param azimuth - Measured from the x-axis positive towards the y-axis
    *           (radians)
   ...
   public void setDetectorPosition(double elevation, double azimuth, double distance, double optWorkingDistance) {
      ...
      final double[] orientation = new double[] {
   ...
   public void setDetectorPosition(double[] pos, double optWd) {
      ...
      setNumericProperty(SpectrumProperties.Elevation, Math.toDegrees(Math.atan2(Math.sqrt((pos[0] * pos[0])
            + (pos[1] * pos[1])), pos[2] - optWd)));
   ...
   public IXRayWindowProperties getWindowProperty(PropertyId pid)
         throws EPQException {
