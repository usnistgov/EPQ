...
abstract public class LinearSpectrumFit
    ...
    * 
    * @param elm An element for which this spectrum is a reference
    * @param ref
   ...
   abstract public KRatioSet getKRatios(ISpectrumData spec)
         throws EPQException;
