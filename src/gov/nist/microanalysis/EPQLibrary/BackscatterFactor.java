...
abstract public class BackscatterFactor extends AlgorithmClass {
   ...
   static public class DuncumbBackscatterFactor extends BackscatterFactor {
      DuncumbBackscatterFactor() {
         super("Duncumb & Reed 1981", new LitReference.BookChapter(LitReference.QuantitativeElectronProbeMicroanalysis,
      ...
      public double compute(Composition comp, AtomicShell shell, double e0) {
         ...
         for (final Element el : comp.getElementSet()) {
            ...
            final double rZ = 1.0 + (((((((((((2.962e-2 * w) - 8.619e-2) * w) + 9.213e-2) * w) - 5.137e-2) * w) + 2.162e-2) * w) - 0.581e-2) * z)
                  + (((((((((((-17.676e-4 * w) + 46.540e-4) * w) - 47.744e-4) * w) + 28.791e-4) * w) - 8.298e-4) * w) - 1.609e-4) * z * z) + (// The
                                                                                                                                              // sign
                                                                                                                                              // of
                                                                                                                                              // the
                                                                                                                                              // 110.700
                                                                                                                                              ...
                                                                                                                                              // is
                                                                                                                                              // right!!!!!)
                  ((((((((((41.792e-6 * w) + 110.700e-6) * w) + 120.050e-6) * w) - 75.733e-6) * w) + 19.184e-6) * w) + 5.4000e-6) * z * z * z)
                  + (((((((((((-42.445e-8 * w) + 117.750e-8) * w) - 136.060e-8) * w) + 88.128e-8) * w) - 21.645e-8) * w) - 5.725e-8) * z * z * z * z)
                  + (((((((((((15.851e-10 * w) - 46.079e-10) * w) + 55.694e-10) * w) - 36.510e-10) * w) + 8.947e-10) * w) + 2.095e-10) * z * z * z * z
                        * z);
