...
public class Transform3D {
   ...
   public static double[] rotate(double[] vector, double phi, double th, double psi) {
      ...
      return new double[]{res.get(0, 0), res.get(1, 0), res.get(2, 0)};
   }
    ...
    * 
    * @param point
    *           double[] - The point to rotate
    * @param pivot
    *           double[] - The pivot point
    * @param phi
    *           double - Initial rotation about z
    * @param theta
    *           double - Second rotation about y
    * @param psi
    *           double - Final rotation about z
    ...
    * 
    * @param point
    *           double[] - The original point
    * @param distance
    *           double[] - The offset
    * @param negate
    *           - true to translate -distance or false to translate +distance
