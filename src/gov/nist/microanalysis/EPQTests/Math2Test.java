...
public class Math2Test
   ...
   public void testErf() {
      ...
      final double[] r = {
         ...
         0.3032224835233542,
         0.11002932963703772,
         0.00003418276664265989,
         1.6346737338997198e-10,
         7.3854368862444885e-25
      };
      final double[] lg = {
         2.12511,
         1.12062,
      ...
      final double[] g = {
         ...
         0.4565498366611956,
         0.01272580112957962,
         0.000056703383632205426,
         1.2987280359516387e-11
      };
   ...
   public void testLegendre() {
      final double[] results = new double[] {
         ...
         -(73379.0 / 262144.0),
         -(1278877.0 / 8388608.0),
         5933243.0 / 33554432.0,
         59377981.0 / 268435456.0
      };
      for(int n = 0; n <= 10; ++n)
