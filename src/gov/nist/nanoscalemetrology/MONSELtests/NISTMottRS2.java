...
public class NISTMottRS2 extends RandomizedScatter {
	 ...
	 * range, the total cross section goes linearly to 0 and the scattering angle
	 * distribution is given by the BrowningEmpiricalCrossSection method.
	 * </p>
	 * <p>
	...
	final public double totalCrossSection(double energy) {
		 ...
		 * energy, it's not clear that any model is accurate. The choice made by this
		 * class is to make the scattering go to zero at low energy. This is similar to
		 * the choice of Kieft & Bosch.
		 */
