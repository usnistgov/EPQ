 ...
 * @author nicholas
 */
final public class XRayTransport3
    ...
    * 
    * @param mcss MonteCarloSS instance
    * @param endPoint The point at which the x-ray transport terminates
    ...
    * 
    * @param mcss MonteCarloSS instance
    * @param det IXRayDetector like EDSDetector, SiLiDetector etc.
    * @return FluorescenceXRayGeneration
    */
