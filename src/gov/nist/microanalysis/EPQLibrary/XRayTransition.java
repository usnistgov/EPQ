...
final public class XRayTransition implements Comparable<XRayTransition>, Cloneable {
	...
	private static final String[] mTransitionNames = { "K\u03B11", "K\u03B12", "K\u03B21", "K\u03B22", "K\u03B23",
			"K\u03B24", "K\u03B25", "L3N2", "L3N3", "L3O2", "L3O3", "L3P1", "L\u03B11", "L\u03B12", "L\u03B215",
			"L\u03B22", "L\u03B25", "L\u03B26", "L\u03B27", "L\u2113", "Ls", "Lt", "Lu", "L2M2", "L2M5", "L2N2", "L2N3",
			"L2N5", "L2O2", "L2O3", "L2P2", "L\u03B21", "L\u03B217", "L\u03B31", "L\u03B35", "L\u03B36", "L\u03B38",
			"L\u03B7", "L\u03BD", "L1M1", "L1N1", "L1N4", "L1O1", "L1O4/L1O5", "L\u03B210", "L\u03B23", "L\u03B24",
			"L\u03B29", "L\u03B32", "L\u03B311", "L\u03B33", "L\u03B34", "L\u03B34p", "M1N2", "M1N3", "M2M4", "M2N1",
			"M2N4", "M2O4", "M3M4", "M3M5", "M3N1", "M3N4", "M3O1", "M3O4", "M3O5", "M\u03B3", "M4N3", "M4O2",
			"M\u03B2", "M\u03B62", "M5O3", "M\u03B11", "M\u03B12", "M\u03B61", "N4N6", "N5N6/N5N7", "Last", "Unnamed",
			"None" };
	...
	public static final int[] ALL_TRANSITIONS = { KA1, KA2, KB1, KB2, KB3, KB4, KB5, L3N2, L3N3, L3O2, L3O3, L3P1, LA1,
			LA2, LB15, LB2, LB5, LB6, LB7, Ll, Ls, Lt, Lu, L2M2, L2M5, L2N2, L2N3, L2N5, L2O2, L2O3, L2P2, LB1, LB17,
			LG1, LG5, LG6, LG8, Ln, Lv, L1M1, L1N1, L1N4, L1O1, L1O4, LB10, LB3, LB4, LB9, LG2, LG11, LG3, LG4, LG4p,
			M1N2, M1N3, M2M4, M2N1, M2N4, M2O4, M3M4, M3M5, M3N1, M3N4, M3O1, M3O4, M3O5, MG, M4N3, M4O2, MB, MZ2, M5O3,
			MA1, MA2, MZ1,
			// named transitions (N shell)
			N4N6, N5N6 };

	// These represent the most common source shells by Seigbahn name.  However, occasionally this shell is not available
	// like LIII in C, so the LII becomes the Ka source shell.  This is implemented in getSourceShell(Element, trans).
	private static final int[] mSourceShell = { AtomicShell.LIII, AtomicShell.LII, AtomicShell.MIII, AtomicShell.NIII, // KB2
			...
			AtomicShell.OIII, AtomicShell.PI, AtomicShell.MV, AtomicShell.MIV, AtomicShell.NIV, AtomicShell.NV,
			AtomicShell.OIV, // LB5 (also OV)
			AtomicShell.NI, AtomicShell.OI, AtomicShell.MI, AtomicShell.MIII, AtomicShell.MII, AtomicShell.NVI,
			AtomicShell.MII, // L2M2
			AtomicShell.MV, AtomicShell.NII, AtomicShell.NIII, AtomicShell.NV, AtomicShell.OII, AtomicShell.OIII, // L2O3
			AtomicShell.PII, AtomicShell.MIV, AtomicShell.MIII, AtomicShell.NIV, AtomicShell.NI, AtomicShell.OIV,
			AtomicShell.OI, // LG8
			AtomicShell.MI, AtomicShell.NVI, AtomicShell.MI, AtomicShell.NI, AtomicShell.NIV, AtomicShell.OI,
			AtomicShell.OIV, // L1O4 (also OV)
			...
			AtomicShell.NI, AtomicShell.NIV, AtomicShell.OIV, AtomicShell.MIV, AtomicShell.MV, AtomicShell.NI,
			AtomicShell.NIV, // M3N4
			AtomicShell.OI, AtomicShell.OIV, AtomicShell.OV, AtomicShell.NV, AtomicShell.NIII, AtomicShell.OII,
			AtomicShell.NVI, // MB
	...
	private static final int[] mDestinationShell = { AtomicShell.K, AtomicShell.K, AtomicShell.K, AtomicShell.K,
			AtomicShell.K, // KB3
			...
			AtomicShell.LII, AtomicShell.LII, AtomicShell.LII, AtomicShell.LII, AtomicShell.LI, AtomicShell.LI,
			AtomicShell.LI, // L1N4
			AtomicShell.LI, AtomicShell.LI, AtomicShell.LI, AtomicShell.LI, AtomicShell.LI, AtomicShell.LI,
			AtomicShell.LI, // LG2
			AtomicShell.LI, AtomicShell.LI, AtomicShell.LI, AtomicShell.LI, AtomicShell.MI, AtomicShell.MI,
			AtomicShell.MII, // M2M4
			...
			AtomicShell.MIV, AtomicShell.MIV, AtomicShell.MIV, AtomicShell.MV, AtomicShell.MV, AtomicShell.MV,
			AtomicShell.MV, // MZ1
	 ...
	 * MFamily) sums to 1.0. This scheme is used when it is only known that one of a
	 * family of lines has been ionized.
	 */
	...
	/**
	 * Normalize the weights so that the heaviest weight KLM line has an amplitude
	 * of 1.0. This normalization scheme is usually used only for displayed KLM
	 * lines.
	 */
	...
	private static void readLineWeights() {
		try {
			synchronized (XRayTransition.class) {
				if (mWeight == null) {
					final double[][] wgt = (new CSVReader.ResourceReader("LineWeights.csv", true))
							.getResource(XRayTransition.class);
					...
					for (int el = 0; el < wgt.length; ++el) {
						...
						if (ew != null) {
							...
							for (int xrt = XRayTransition.KA1; xrt < (XRayTransition.KA1 + ew.length); ++xrt)
								dNorm[XRayTransition.getDestinationShell(xrt) - AtomicShell.K] += ew[xrt
										- XRayTransition.KA1];
	...
	private int getSourceShell(Element elm, int trans) {
		...
		// Some transitions are not consisent with the standard naming schemes. For
	 ...
	 * 
	 * @param el    Element
	 * @param trans int - One of the named transition KA1 to N5N6
	 */
	...
	/**
	 * XRayTransition - Create an object corresponding to a specific x-ray
	 * transition in a specific element. This method will swap src and destination
	 * to make certain that dest is more tightly bound than src.
	 * 
	 * @param element Element
	 * @param src     int - One of the AtomicShell.K to AtomicShell.PXI
	 * @param dest    int - One of the AtomicShell.K to AtomicShell.PXI
	 */
	...
	/**
	 * XRayTransition - Create an object corresponding to a transition between the
	 * specified destination (dest) shell and the specific source shell (srcShell)
	 * 
	 * @param dest     AtomicShell - The inner most shell involved in the
	 *                 transition.
	 * @param srcShell int - One of the AtomicShell.K to AtomicShell.PXI
	 */
	...
	/**
	 * getSourceShell - Get the (typically valence) shell from which the electron
	 * starts its transition to the (typically core) shell for the specified named
	 * transition.
	 * 
	 * @param xrt - a named transition
	 * @return int
	 */
	 ...
	 * x-ray emission process. The destination shell is typically a core electron.
	 * 
	 * @return int
	 */
	...
	/**
	 * getDestination - Get the shell to which the electron jumps during the x-ray
	 * emission process. The destination shell is typically a core electron.
	 * 
	 * @return AtomicShell
	 */
	 ...
	 * isWellKnown - In this transition one of the well-known named transitions.
	 * 
	 * @param trans int - a transition in the range [KA1,Last)
	 * @return boolean
	 */
	 ...
	 * 
	 * @param xrt - The index of an x-ray transition
	 * @return String
	 */
	static public String getIUPACName(int xrt) {
		return xrt != Unnamed
				? AtomicShell.getIUPACName(getDestinationShell(xrt)) + "-"
						+ AtomicShell.getIUPACName(getSourceShell(xrt))
				: "Unnamed";
	}
	...
	/**
	 * getEnergy - Get the x-ray energy associated with the specified transition for
	...
	/**
	 * getEdgeEnergy - Get the edge energy associated with the specified transition
	...
	/**
	 * getEdgeEnergy - Returns the mininum electron energy required to excite this
	 * transition.
	 * 
	 * @return double
	 */
	...
	/**
	 * getWeight - Gets the transition weight associated with this transition. The
	 * mode determines how the weights are normalized. Depending upon the use,
	 * various different wieghting schemes can be appropriate.
	 * 
	 * @param mode int One of DefaultNormalization, NormalizeFamily, or
	 *             NormalizeDestination
	 * @return double
	 * @throws EPQFatalException - When weight data is unavailable
	 */
		...
		if (isWellKnown(mTransition)) {
			...
			case NormalizeFamily:
				return (mWeight[ani] != null) && (mTransition < mWeight[ani].length)
						? mWeight[ani][mTransition]
								/ mFamNormalization[ani][mDestination.getFamily() - AtomicShell.KFamily]
						: 0.0;
			...
			case NormalizeKLM:
				return (mWeight[ani] != null) && (mTransition < mWeight[ani].length)
						? mWeight[ani][mTransition]
								/ mKLMNormalization[ani][mDestination.getFamily() - AtomicShell.KFamily]
						: 0.0;
			}
		}
		return 0.0;
	...
	/**
	 * getWeight - Gets the transition weight associated with the specified elemet
	 * and transition. The mode determines how the weights are normalized. Depending
	 * upon the use, various different wieghting schemes can be appropriate.
	 * 
	 * @param mode int One of DefaultNormalization, NormalizeFamily, or
	 *             NormalizeDestination
	 * @return double
		...
		if (isWellKnown(trans)) {
			...
			case NormalizeFamily:
				return (mWeight[ani] != null) && (trans < mWeight[ani].length)
						? mWeight[ani][trans]
								/ mFamNormalization[ani][XRayTransition.getFamily(trans) - AtomicShell.KFamily]
						: 0.0;
			case NormalizeDestination:
				return (mWeight[ani] != null) && (trans < mWeight[ani].length)
						? mWeight[ani][trans]
								/ mDestNormalization[ani][XRayTransition.getDestinationShell(trans) - AtomicShell.K]
						: 0.0;
			case NormalizeKLM:
				return (mWeight[ani] != null) && (trans < mWeight[ani].length)
						? mWeight[ani][trans]
								/ mKLMNormalization[ani][XRayTransition.getFamily(trans) - AtomicShell.KFamily]
						: 0.0;
			}
		}
		return 0.0;
	 ...
	 * transition. The weight of the dominant line in each family is normalized to a
	 * sum of 1.0.
	 * 
	 * @throws EPQFatalException - When weight data is unavailable
	 * @return double
	...
	/**
	 * getFamily - A static method for returning the family with which a transition
	 * is associated.
	 * 
	 * @param xrt int - A valid named transition index
	...
	public static XRayTransition getStrongestLine(AtomicShell shell) throws EPQException {
		...
		for (int line = KA1; line < Last; ++line)
			if (mDestinationShell[line - KA1] == shell.getShell()) {
				final double wgt = (mWeight[zp] != null) && ((line - KA1) < mWeight[zp].length)
						? mWeight[zp][line - KA1]
						: 0.0;
				if (wgt > bestWeight) {
					bestLine = line;
	...
	/**
	 * compareTo - Orders by atomic number then by destination shell and finally by
	 * source shell.
	 * 
	 * @param xrt
	 * @return int
	...
	/**
	 * createByDestinationShell - Creates a list of all x-ray transition lines that
	 * may occur when the destination shell is empty.
	 * 
	 * @param dest AtomicShell
	...
	public static Collection<XRayTransition> createByDestinationShell(AtomicShell dest) {
		...
		for (int xrt = KA1; xrt < Last; ++xrt)
			if (XRayTransition.getDestinationShell(xrt) == dest.getShell()) {
				...
				if ((tr.getSource().getGroundStateOccupancy() > 0)
						&& (XRayTransition.occurs(dest.getElement().getAtomicNumber(), xrt)))
					al.add(tr);
			}
		return al;
	}
	...
	/**
	 * getLastIntoShell - Get the last (plus one) transition (ordered by the order
	 * of the enumerated shell index) that ends in the specified shell.
	 * 
	 * @param shell AtomicShell
	...
	/**
	 * lineWithHighestEnergy - Returns the line index of the line in the specified
	 * family with the highest x-ray energy.
	 * 
	 * @param el     Element
	 * @param family int
	 * @return int
	...
	/**
	 * exists - The specified x-ray transition exists (with non-zero weight) for the
	 * specified element? (ie. You might see x-rays from this transition in a sample
	 * of this material.)
	 * 
	 * @param el  Element
	 * @param xrt int
	...
	/**
	 * exists - Does this x-ray transition exists (with non-zero weight)? (ie. You
	 * might see x-rays from this transition in a sample of this material.)
	 * 
	 * @return boolean
	 */
	...
	/**
	 * shouldExist - Should this transition exist (as an x-ray transition) based on
	 * whether the electric dipole and quadrupole selection rules permit the
	 * transition and whether in a ground state atom both the source and destination
	 * shells are occupied.
	 * 
	 * @return boolean
	 */
	 ...
	 * shells are occupied.
	 * 
	 * @param src  AtomicShell
	 * @param dest AtomicShell (note: src.getAtomicNumber()==dest.getAtomicNumber())
	 * @return boolean
	 */
	 ...
	 * @param shell int - The destination (lower energy) shell
	...
	/**
	 * TransitionFromShells - Returns an integer representing the named transition
	 * when an electron goes from src to dest.
	 * 
	 * @param src  int
	 * @param dest int
	 * @return int
	...
	/**
	 * transitionsIntoShell - Returns a list of the integer indexes of transitions
	 * that end in the specified shell.
	 * 
	 * @param shell One of AtomicShell.K to AtomicShell.NV
	 * @return int[]
	 */
	...
	/**
	 * Does one or more transitions exist for the specified element and transition
	 * family.
	 * 
	 * @param el     An element
	 * @param family - One of AtomicShell.KFamily, AtomicShell.LFamily,
