 ...
 * 
 */
public class StageRelocationTest
   extends TestCase {
   ...
   public void testStageRelocation() {
      ...
      for(int i = 0; i < 1000; ++i) {
         final double[] pt = new double[] {
            2.0 * (0.5 - mRandom.nextDouble()),
            2.0 * (0.5 - mRandom.nextDouble())
         };
   ...
   public void testStageRelocation2()
      ...
      { // Test two point relocation
         ...
         {
            final StageRelocation sr = new StageRelocation(al, false);
            assertTrue(Math2.distance(new double[] {
               -8.9127,
               2.87814
            }, sr.apply(new double[] {
               -6.0,
         ...
         }));
         {
            ...
            assertTrue(Math2.distance(new double[] {
               3.0,
               4.0
            }, sr.inverse(sr.apply(new double[] {
               3.0,
               4.0
            }))) < 0.01);
    ...
    * .
    */
   public void testStageRelocation3()
         throws EPQException {
      { // Test one point relocation
         final ArrayList<StageRelocation.RelocatedPoint> al = new ArrayList<StageRelocation.RelocatedPoint>();
         al.add(new StageRelocation.RelocatedPoint(new double[] {
