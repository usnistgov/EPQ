...
public class SparskitFEArunner implements IFEArunner {
    ...
    * diagonal element) <br>
    * - ILUK : each element whose fill-in level is greater than NB_FILL is
    * dropped. <br>
    * - default : 10
    * </p>
    *
    ...
    * - ILUT/ILUTP/ILUK: a(i,j) is dropped if abs(a(i,j)) &lt;
    * DROPPING_TOLERANCE * abs(diagonal element in U). <br>
    ...
    * * (sum of all dropped elements of the line)' is added to the diagonal
    * element in U <br>
