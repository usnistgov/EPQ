...
public class Armstrong1982Base extends ZAFCorrectionAlgorithm {
	...
	static private final LitReference RefBrownJTA = new LitReference.BookChapter(LitReference.MicrobeamAnalysis,
			"175-180", new Author[] { LitReference.JArmstrong });
	...
	public double generated(XRayTransition xrt) {
		...
		final double generated = (Math.sqrt(Math.PI) * mGamma0 * 0.5
				* (1.0 - (Math.exp(xx * xx) * mQ * Math2.erfc(xx)))) / mAlpha;
