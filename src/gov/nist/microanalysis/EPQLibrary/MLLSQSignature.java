...
public class MLLSQSignature {
   ...
   public void addReference(Element elm, Composition comp, ISpectrumData spec)
         throws EPQException {
      mFilterFit = null;
    ...
    * @throws EPQException
    */
   public KRatioSet compute(ISpectrumData spec)
         throws EPQException {
            ...
            if(mOptimal == null) {
               ...
               for(final Map.Entry<Element, ISpectrumData> me : mStandards.entrySet()) {
                  ...
                  if(bestRoi != null) {
                     ...
                     /**
                      * Iref -> Measured intensity of reference Ipure =
                      * Iref/(wRef*ZAFref) wUnk ~ Iunk / Ipure =
                      * Iunk/(Iref/(wRef*ZAFref)) = (Iunk/Iref)*wRef*ZAFref
                      */
   ...
   /**
    * Returns the value of fit quality calculated as a result of the last call
   ...
   /**
    * Add an element to the list of elements which will be stripped (ie. ignored
    * in the signature)
    * 
    * @param elm
    */
   ...
   /**
    * Clear the exclusion set so that all elements for which there are
    * references is fit.
    */
   ...
   /**
    * Returns a set of elements which are excluded from the signature fit. Even
    * if a reference exists for this element it will not be fit.
    * 
    * @return TreeSet&gt;Element&lt;
    */
