 ...
 * @version 1.0
 */
public class LinearLeastSquaresTest extends TestCase {

   public void testAster2_1() throws EPQException {
      final double[] x = new double[]{1.0000, 2.0000, 3.0000, 4.0000, 5.0000, 6.0000, 7.0000, 8.0000, 9.0000, 10.0000};
      final double[] y = new double[]{109.3827, 187.5385, 267.5319, 331.8753, 386.0535, 428.4271, 452.1644, 498.1461, 512.3499, 512.9753};
      final double[] dy = new double[]{8.0000, 8.0000, 8.0000, 8.0000, 8.0000, 8.0000, 8.0000, 8.0000, 8.0000, 8.0000};
