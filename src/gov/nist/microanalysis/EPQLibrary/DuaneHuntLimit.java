 ...
 * @version 1.0
 */
abstract public class DuaneHuntLimit extends AlgorithmClass {
   ...
   public List<AlgorithmClass> getAllImplementations() {
      return Arrays.asList(new AlgorithmClass[]{LinearDuaneHunt, CrudeDuaneHunt, AltDuaneHunt});
   }
   ...
   static private class CrudeDuaneHuntAlgorithm extends DuaneHuntLimit {
   ...
   static private class AltDuaneHuntAlgorithm extends DuaneHuntLimit {
   ...
   static private class LinearDuaneHuntAlgorithm extends DuaneHuntLimit {
