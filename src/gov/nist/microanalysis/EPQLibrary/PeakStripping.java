 ...
 */
abstract public class PeakStripping
   extends
   AlgorithmClass {
   ...
   static public class Ryan1988PeakStripping
      extends
      PeakStripping {
   ...
   static public class Clayton1987PeakStripping
      extends
      PeakStripping {
   ...
   static public class VanEspen2002PeakStripping
      extends
      PeakStripping {
      ...
      public VanEspen2002PeakStripping() {
         super("Van Espen 2002", new LitReference.BookChapter(LitReference.HandbookOfXRaySpectrometry, new LitReference.Author[] {
            new LitReference.Author("Piet", "Van Espen", "")
         }));
      }
