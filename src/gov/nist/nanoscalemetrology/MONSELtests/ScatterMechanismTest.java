...
public class ScatterMechanismTest {
	...
	*/
	 ...
	 *             divided
	 * @return -- an array double[n] of scatter rates at the corresponding energies
	 */
	...
	/**
	 * @return - average microsections per scatter() call by the most recent call to
	 *         SE_kE_Histogram() or PE_Theta_Histogram()
	 */
