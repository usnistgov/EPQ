...
abstract public class EdgeEnergy extends AlgorithmClass {
   ...
   public static class DiracHartreeSlaterIonizationEnergies extends EdgeEnergy {
      ...
      public DiracHartreeSlaterIonizationEnergies() {
         super("Bote-Salvat 2008",
               new LitReference.JournalArticle(LitReference.PhysRevA, "77", "042701-1 to 24", 2008,
                     new LitReference.Author[]{
                           new LitReference.Author("David", "Bote",
   ...
   public static class WilliamsEdgeEnergy extends EdgeEnergy {
      ...
      protected WilliamsEdgeEnergy() {
         super("Williams-2011",
               new LitReference.JournalArticle("Electron binding energies of the elements",
                     new LitReference.Journal("CRC Handbook of Chemistry and Physics", "CRC Chem Phys", "CRC"), "91st", "221-226", 2011,
                     new LitReference.Author[]{new LitReference.Author("G. P.", "Williams")}));
   ...
   static private final AlgorithmClass[] mAllImplementations = {EdgeEnergy.DTSA, EdgeEnergy.Chantler2005, EdgeEnergy.NISTxrtdb, EdgeEnergy.Wernish84,
         EdgeEnergy.DHSIonizationEnergy, EdgeEnergy.Williams2011, EdgeEnergy.SuperSet};
