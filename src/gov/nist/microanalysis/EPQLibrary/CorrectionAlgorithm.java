 ...
 * @version 1.0
 */
abstract public class CorrectionAlgorithm
   extends
   AlgorithmClass
   implements
   Comparable<AlgorithmClass> {
    ...
    * @throws EPQException
    */
   public double[] relativeZAF(Composition comp, XRayTransition xrt, SpectrumProperties props)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public double[] relativeZAF(Composition comp, XRayTransitionSet xrts, SpectrumProperties props, Composition standard)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public double relativeA(Composition comp, XRayTransition xrt, SpectrumProperties props)
         throws EPQException {
      final Material mat = new Material(new Element[] {
         xrt.getElement()
      }, new double[] {
         1.0
      }, ToSI.gPerCC(5.0), xrt.getElement().toAbbrev());
    ...
    * @throws EPQException
    */
   public double relativeZ(Composition comp, XRayTransition xrt, SpectrumProperties props)
         throws EPQException {
    ...
    * @return double
    */
   abstract public double computeZACorrection(XRayTransition xrt)
         throws EPQException;
    ...
    * @throws EPQException
    */
   public double computeZAFCorrection(XRayTransition xrt)
         throws EPQException {
    ...
    * @throws EPQException
    */
   public double computeKRatio(Composition comp, XRayTransition xrt, SpectrumProperties sp)
         throws EPQException {
      final Composition elmMat = new Composition(new Element[] {
         xrt.getElement()
      }, new double[] {
         1.0
      });
   ...
   public double computeKRatio(Composition unk, Composition std, XRayTransition xrt, SpectrumProperties sp)
      ...
      if(sp.isDefined(SpectrumProperties.SampleShape)) {
         ...
         stdSp.removeAll(Arrays.asList(new SpectrumProperties.PropertyId[] {
            SpectrumProperties.SampleShape,
            SpectrumProperties.SpecimenDensity,
    ...
    * @throws EPQException - If the xrt is not a well known transition or
    *            take-off angle out of range.
    */
   public double chi(XRayTransition xrt)
         throws EPQException {
    ...
    *            take-off angle out of range.
    */
   public UncertainValue2 chiU(XRayTransition xrt)
         throws EPQException {
      if(Math.abs(mExitAngle) > ((Math.PI * 89.99) / 180.0))
         throw new EPQException("The take-off angle is outside the range [-89.99\u00B0), 89.99\u00B0].");
      final MassAbsorptionCoefficient mac = (MassAbsorptionCoefficient) getAlgorithm(MassAbsorptionCoefficient.class);
   ...
   static public class ZAFCorrectionAlgorithm
      extends
      CorrectionAlgorithm {
      ...
      @Override
      public boolean initialize(Composition comp, AtomicShell shell, SpectrumProperties prop)
            throws EPQException {
         final boolean res = super.initialize(comp, shell, prop);
         if(res) {
            mPureElement = new Composition(new Element[] {
               shell.getElement()
            }, new double[] {
               1.0
            });
      ...
      public double computeZACorrection(XRayTransition xrt)
         ...
         final BackscatterFactor bs = (BackscatterFactor) getAlgorithm(BackscatterFactor.class);
         final StoppingPower sp = (StoppingPower) getAlgorithm(StoppingPower.class);
         assert Math.abs(mTakeOffAngle
               - mExitAngle) < Math.toRadians(1.0) : "The take-off and exit angles should agree to within 1\u00B0";
    ...
    */
   public static class NullCorrectionAlgorithm
      extends
      CorrectionAlgorithm {
    ...
    * algorithm.
    */
   static public class DiagnosticCorrectionAlgorithm
      extends
      CorrectionAlgorithm {
    ...
    * @version 1.0
    */
   abstract static public class PhiRhoZAlgorithm
      extends
      CorrectionAlgorithm {
      ...
      public double computeAbsorbedCurve(XRayTransition xrt, double rhoZ)
            throws EPQException {
