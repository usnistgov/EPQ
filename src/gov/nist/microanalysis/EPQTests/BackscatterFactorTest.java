 ...
 * @version 1.0
 */
public class BackscatterFactorTest extends TestCase {
   ...
   public void testOne() throws EPQException {
      ...
      final double e0 = ToSI.keV(20.0);
      {
         ...
         final AtomicShell[] shells = {new AtomicShell(Element.Ca, AtomicShell.K), new AtomicShell(Element.Fe, AtomicShell.LIII),
               new AtomicShell(Element.Si, AtomicShell.K), new AtomicShell(Element.O, AtomicShell.K)};
      ...
      {
         final BackscatterFactor algs[] = {BackscatterFactor.Yakowitz1973, BackscatterFactor.Pouchou1991, BackscatterFactor.Love1978};
         final double answer[] = {1.0072, 1.0081, 1.0065};
         ...
         for (int i = 0; i < algs.length; ++i) {
            ...
            final double res = alg.compute(comp, shell, e0) / alg.compute(MaterialFactory.createPureElement(shell.getElement()), shell, e0);
      ...
      {
         final BackscatterFactor algs[] = {BackscatterFactor.Yakowitz1973, BackscatterFactor.Pouchou1991, BackscatterFactor.Love1978};
         final double answer[] = {0.9988, 1.0003, 0.9990};
   ...
   public void testLove78A() throws EPQException {
      ...
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         ...
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0528, 0.001);
      }
   }

   public void testLove78B() throws EPQException {
      final BackscatterFactor bs = BackscatterFactor.Love1978;
      final double e0 = ToSI.keV(20.0);
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         final AtomicShell sh = new AtomicShell(Element.Ti, AtomicShell.K);
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0635, 0.001);
      }
   }
   ...
   public void testPouchou91A() throws EPQException {
      ...
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         ...
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0448, 0.001);
      }
   }
   ...
   public void testPouchou91B() throws EPQException {
      ...
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         ...
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0544, 0.001);
      }
   }

   public void testDuncumb81A() throws EPQException {
      ...
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         final AtomicShell sh = new AtomicShell(Element.Ca, AtomicShell.K);
         // assertEquals(bs.compute(mat, sh, e0), 0.228, 0.001);
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0396, 0.001);
      }
   }

   public void testDuncumb81B() throws EPQException {
      final BackscatterFactor bs = BackscatterFactor.Duncumb1981;
      final double e0 = ToSI.keV(20.0);
      final Composition mat = MaterialFactory.createMaterial(MaterialFactory.K3189);
      {
         final AtomicShell sh = new AtomicShell(Element.Ti, AtomicShell.K);
         // assertEquals(bs.compute(mat, sh, e0), 0.248, 0.001);
         assertEquals(bs.compute(mat, sh, e0) / bs.compute(MaterialFactory.createPureElement(sh.getElement()), sh, e0), 1.0613, 0.001);
      }
   }
