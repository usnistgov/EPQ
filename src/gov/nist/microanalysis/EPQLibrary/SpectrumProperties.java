...
public class SpectrumProperties implements Cloneable, Serializable {
	...
	static public class PropertyId implements Comparable<PropertyId> {
		 ...
		 * Boolean, ImageType, Textual or Unknown) to represent the type of item stored
		 * in a property identified with this PropertyId.
		 * 
		 * @return int
		 */
	...
	/**
	 * The display name of the spectrum. This is the string that toString returns.
	 */
	...
	/**
	 * A field (sometimes an index number) identifying the sample within a project
	 * or within a sample block.
	 */
	...
	/**
	 * A field (sometimes a number) identifying the project with which this spectrum
	 * is associated.
	 */
	...
	/**
	 * The time at which the spectrum was aquired. This is reported as the number of
	...
	/**
	 * The angle between the detector normal and the a vector between the sample and
	 * the detector.
	 */
	public static final PropertyId DetectorTilt = new PropertyId("Detector tilt", "\u00B0", "0.#");

	/**
	 * The angle at which the beam comes off of the sample. This angle is defined by
	 * the point at which the x-ray is emitted and the location of the detector. In
	 * degrees measured from the x-y plane towards the z-axis. This differs from
	 * Elevation in that it includes both the Elevation of the detector and the
	 ...
	 * The thickness of the detector window in micrometers (\u00B5).
	 */
	public static final PropertyId BoronNitrideWindow = new PropertyId("Boron nitride window thickness", " \u00B5m",
			"0.#");

	/**
	 * The thickness of the detector window in micrometers (\u00B5).
	 */
	public static final PropertyId SiliconNitrideWindow = new PropertyId("Silicon nitride window thickness", " \u00B5m",
			"0.#");
	 ...
	 * The thickness of the detector window in micrometers (\u00B5).
	 */
	public static final PropertyId HydroCarbonWindow = new PropertyId("Hydrocarbon window thickness", " \u00B5m",
			"0.#");
	...
	/**
	 * The thickness (in nanometers) of the nickel layer coating the surface of the
	 * detector.
	 */
	...
	/**
	 * The thickness (in nanometers) of the boron layer coating the surface of the
	 * detector.
	 */
	public static final PropertyId BoronLayer = new PropertyId("Boron layer thickness", " nm", "0.#");

	/**
	 * The thickness (in nanometers) of the carbon layer coating the surface of the
	 * detector.
	 */
	...
	/**
	 * The thickness (in nanometers) of the oxygen layer coating the surface of the
	 * detector.
	 */
	...
	// Contamination
	/**
	 * Estimated thickness (in micrometers) of the ice layer covering the window of
	 * the detector.
	 */
	public static final PropertyId IceThickness = new PropertyId("Ice layer thickness", " \u00B5m", "0.#");
	/**
	 * Estimated thickness (in micrometers) of the oil layer covering the window of
	 * the detector.
	 */
	public static final PropertyId OilThickness = new PropertyId("Oil layer thickness", " \u00B5m", "0.#");

	/**
	 * Estimated thickness (in nanometers) of the carbon layer coating the surface
	 * of the sample.
	 */
	...
	/**
	 * Type of X-ray Detector, allowed values are EDSDetector.SILI, EDSDetector.SDD,
	 * EDSDetector.MICROCAL
	 */
	...
	/**
	 * The quadratic term in the energy calibration (rarely used and often ignored.)
	 */
	public static final PropertyId EnergyQuadratic = new PropertyId("Energy Quadratic", " eV/ch^2", "0.00000000");

	/**
	 * The measured detector resolution at the energy specified by ResolutionLine.
	 */
	public static final PropertyId Resolution = new PropertyId("Resolution", " eV", "0.#");

	/**
	 * The energy of the line at which the resolution of the detector was measured.
	 */
	public static final PropertyId ResolutionLine = new PropertyId("Resolution measurement energy", " eV", "0");

	/**
	 * The fano-factor associated with this detector (detector that collected this
	 * spectrum)
	 */
	 ...
	 * allow higher energy x-rays to pass unabsorbed. The quantum efficiency then is
	 * not a constant but depends on energy.
	 */
	...
	/**
	 * IsTemporary - Is the spectrum of ephemeral use? Temporary spectra are never
	 ...
	 * from the a zero stablization peak. In eV since the position in channels may
	 * shift.
	 */
	 ...
	 * implied by the objective current necessary to bring the beam into focus (in
	 * mm).
	 */
	public static final PropertyId WorkingDistance = new PropertyId("Working distance", " mm", "0.0#");
	/**
	 * EmissionCurrent - The emission current in microamps. Not this is the amount
	 * of emission from the gun not the amount that strikes the sample.
	 */
	 ...
	 * magnification. Nominally I use a 3.5" display size to calculate mag. I can't
	...
	/**
	 * SpecimenDensity - Nominal or estimated specimen density in g/cc. Required to
	 * compute film and other non-bulk quantitative corrections.
	 */
	 ...
	 */
	public static final PropertyId MicroanalyticalComposition = new PropertyId("Microanalytical Composition",
			Composition.class);

	/**
	 * ParticleSignature - A ParticleSignature object containing the result of a
	 * particle signature measurement. This is associated with Graf but defined in
	 * EPQLibrary.
	 */
	...
	/**
	 * SampleShape - A SampleShape object containing a description of the particle
	 * shape.
	 */
	...
	/**
	 * OptimalKRatios - The full K-ratio set trimmed down to one k-ratio per element
	 * as was deemed optimal by the filter fit and quantitative correction
	 * algorithm.
	 */
	public static final PropertyId OptimalKRatios = new PropertyId("Optimal K-Ratios", KRatioSet.class);

	/**
	 * ChiSquare statistic associated with the most recent fit - the one producing
	 * the OptimalKRatios propery.
	 */
	public static final PropertyId ChiSquare = new PropertyId("ChiSquare", "", "0.##");

	/**
	 * The ReducedChiSquare statistic associated with the most recent fit - the one
	...
	/**
	 * Orientation of a normal to the surface of the EDS detector (out-of-the-face
	 * of the detector)
	 */
	 ...
	 * Preferentially set this property via one of the setDetectorPosition methods.
	 */
	public static final PropertyId DetectorPosition = new PropertyId("Detector position", " mm", Array.class);

	/**
	 * Some kind of descriptive information about the detector on which a spectrum
	 * was acquired. Not the detector name.
	 */
	 ...
	 */
	public static final PropertyId ConductiveCoating = new PropertyId("Conductive coating", "",
			ConductiveCoating.class);
	...
	public enum PropertyType {
		...
		/**
		 * Numeric - This property type is most naturally representated as a double
		...
		/**
		 * Boolean - This property type is most naturally represented as a boolean value
		 * ('true' or 'false')
		 */
		Boolean,

		/**
		 * Timestamp - This property type is most naturally represented as a date and
		 * time.
		 */
		Timestamp,
		...
		/**
		 * CompositionType - This property type is most naturally represented as an
		 * Composition object.
		 */
		CompositionType,
	...
	private static Map<String, PropertyId> createPredefinedPropertyMap() {
		...
		final PropertyId[] contents = new PropertyId[] { SpectrumIndex, SpecimenName, SpectrumDisplayName, SpecimenDesc,
				SampleId, ClientsSampleID, ClientName, ProjectName, SourceFile, InstrumentOperator, Analyst, Software,
				AcquisitionTime, Azimuth, Elevation, DetectorArea, DetectorThickness, DetectorTilt, DetectorOptWD,
				TakeOffAngle, DetectorDistance, SolidAngle, WindowType, DiamondWindow, MylarWindow, BoronNitrideWindow,
				SiliconNitrideWindow, SiliconNitrideWindow, ParaleneWindow, PyroleneWindow, MoxtekWindow,
				HydroCarbonWindow, BerylliumWindow, AluminumWindow, BoronLayer, CarbonLayer, NitrogenLayer, OxygenLayer,
				GoldLayer, NickelLayer, AluminumLayer, IceThickness, CarbonCoating, DeadLayer, ActiveLayer,
				DetectorType, DetectorWindow, EnergyScale, EnergyOffset, EnergyQuadratic, Resolution, ResolutionLine,
				QuantumEfficiency, MassThickness, IntegrationTime, DwellTime, SpectrumComment, SpectrumClass,
				...
				StandardComposition, ElementList, StandardizedElements, KRatios, OptimalKRatios, ChiSquare,
	...
	public static List<PropertyId> WINDOW_PROPERTIES = Arrays.asList(new PropertyId[] { WindowType, DiamondWindow,
			MylarWindow, BoronNitrideWindow, SiliconNitrideWindow, SiliconNitrideWindow, ParaleneWindow, PyroleneWindow,
			MoxtekWindow, HydroCarbonWindow, BerylliumWindow, AluminumWindow,
			// IceThickness,
			// BoronLayer,
			// CarbonLayer,
			// NitrogenLayer,
	...
	private static List<PropertyId> DETECTOR_PROPERTIES = Arrays.asList(new PropertyId[] { Azimuth, Elevation,
			DetectorArea, DetectorThickness, DetectorTilt, DetectorOptWD, TakeOffAngle, DetectorDistance, SolidAngle,
			// WindowType,
			// DiamondWindow,
			// MylarWindow,
			// BoronNitrideWindow,
			...
			// BerylliumWindow,
			// AluminumWindow,
			GoldLayer, NickelLayer, AluminumLayer, IceThickness, DeadLayer, ActiveLayer, DetectorType, DetectorWindow,
			EnergyScale, EnergyOffset, EnergyQuadratic, Resolution, ResolutionLine, QuantumEfficiency, SignalType,
			DetectorOrientation, DetectorPosition, LLD, PulseProcessorType, PulseProcessTime, PulseProcessorSetting,
			CollectionAngle, Instrument, Detector, FanoFactor, DetectorDescription, DetectorGUID, CalibrationGUID });
	/**
	 * mProperty - Contains the list of propertry strings that have been assigned to
	 * this SpectrumProperty object. pid = null indicates that this property has
	 ...
	 * 
	 * @param parentProps SpectrumProperties
	 */
	...
	/**
	 * Create a new SpectrumProperty object containing all the properties which are
	 * defined equivalently in both sp1 and sp2.
	 * 
	 * @param sp1 (may be null)
	 * @param sp2
	 ...
	 * 
	 * @param sp1 SpectrumProperties
	 * @param sp2 SpectrumProperties
	 * @return SpectrumProperties
	 */
	 ...
	 * This method throws an exception if the named property is not found.
	 * 
	 * @param pid String
	 * @throws EPQException
	 * @return String
	...
	public String getTextProperty(PropertyId pid) throws EPQException {
		...
		case ImageType:
			return res instanceof BufferedImage
					? Integer.toString(((BufferedImage) res).getWidth()) + " \u00D7 "
							+ Integer.toString(((BufferedImage) res).getHeight()) + " image"
					: "Image";
		case KRatioType:
			return res.toString();
	 ...
	 * string. This method throws an exception if the named property is not found.
	 * 
	 * @param pid String
	 * @throws EPQException
	 * @return String
	 ...
	 * this version returns the default value (def) if the property is not defined.
	 * 
	 * @param pid String
	 * @param def String
	 * @return String
	...
	/**
	 * setTextProperty - Sets the value (val) of the specified (pid) property. Any
	 * previous definition is overwritten.
	 * 
	 * @param pid String
	 * @param val String
	 */
	...
	/**
	 * getNumericWithDefault - Similar to getNumericProperty except that instead of
	 * throwing an Exception, the default value (def) is returned if
	...
	/**
	 * getCompositionWithDefault - Get the Composition associated with the specified
	 * PropertyId. If none is defined return comp.
	 * 
	 * @param pid
	 * @param comp
	 * @return The Composition
	...
	/**
	 * setCompositionProperty - Sets the Composition associated with the specified
	 * PropertyId
	 * 
	 * @param pid
	 * @param comp
	...
	/**
	 * getParticleShapeProperty - Get the BrownJTA1982p.Shape object associated with
	...
	/**
	 * getParticleSignatureWithDefault - Get the ParticleSignature associated with
	...
	/**
	 * getParticleShapeWithDefault - Get the BrownJTA1982p.Shape associated with the
	 * specified PropertyId. If none is defined return sig.
	 * 
	 * @param pid
	 * @param sig
	...
	/**
	 * setParticleSignatureProperty - Sets the ParticleSignature associated with the
	 * specified PropertyId
	 * 
	 * @param pid
	 * @param sig
	...
	/**
	 * getTimestampProperty - Gets the date and time associated with the specified
	 * property.
	 * 
	...
	/**
	 * getTimestampWithDefault - Similar to getTimestampProperty except that instead
	 * of throwing an EPQException, the default value (def) is returned if
	 * getTimestampProperty would throw an exception.
	 * 
	 * @param pid String
	 * @param def Date
	 * @return Date
	...
	/**
	 * Sets the properties associated with the position and orientation of the x-ray
	 * detector. Uses an algorithm which *assumes* that at the detector points
	 * directly at the point (0.0, 0.0, optWorkingDistance) from the specified
	 * elevation and azimuth. To determine the optWorkingDistance determine the
	 * point at which the detector points on the beam axis. Place a sample there.
	 * Focus on the sample and then record the working distance.
	 * 
	 * @param elevation          - Elevation up from the x-y plane (radians)
	 * @param azimuth            - Measured from the x-axis positive towards the
	 *                           y-axis (radians)
	 * @param distance           - Distance from (0.0,0.0,optWorkingDistance) to the
	 *                           detector (in meters)
	 * @param optWorkingDistance - The optimal working distance (in meters)
	 */
	public void setDetectorPosition(double elevation, double azimuth, double distance, double optWorkingDistance) {
		...
		final double[] orientation = new double[] { -Math.cos(elevation) * Math.cos(azimuth),
		...
		// Position in mm
		final double[] position = Math2.minus(Math2.multiply(optWorkingDistance, Math2.Z_AXIS),
				Math2.multiply(distance, orientation));
	 ...
	 * 
	 * @param pos   double[3] in meters
	 * @param optWd in meters
	 */
	public void setDetectorPosition(double[] pos, double optWd) {
		...
		setNumericProperty(SpectrumProperties.Elevation,
				Math.toDegrees(Math.atan2(Math.sqrt((pos[0] * pos[0]) + (pos[1] * pos[1])), pos[2] - optWd)));
	...
	/**
	 * clear - Clear the specified properties identified by this list of PropertyId
	 * objects from this SpectrumProperties.
	 * 
	 * @param props PropertyId[]
	 */
	...
	/**
	 * getPropertySet - Returns a list of the PropertyId objects associated with all
	 * the properties available for this spectrum.
	 * 
	...
	/**
	 * getPropertyType - Gets the actual property type associated with this property
	 * (in contrast with what PropertyId.getPropertyType says). They had better
	 * agree!!!
	 * 
	 * @param pid PropertyId
	 * @return PropertyType
	 ...
	 * SpectrumProperties object. Does not overwrite previously define properties.
	 * (see addAll which does overwrite previously defined properties.)
	 * 
	 * @param props
	 */
	 ...
	 * represented by this spectrum - StandardComposition first, ElementList second
	 * and MicroanalyticalComposition last.
	 * 
	 * @return Set&lt;Element&gt;
	 */
