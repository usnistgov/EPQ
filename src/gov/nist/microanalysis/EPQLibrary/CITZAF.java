...
public class CITZAF {
   ...
   public static final class CITZAFCorrectionAlgorithm {
      ...
      public static CITZAFCorrectionAlgorithm[] getAllImplimentations() {
         return new CITZAFCorrectionAlgorithm[]{ARMSTRONG_LOVE_SCOTT, CONVENTIONAL_PHILIBERT_DUNCUMB_REED, HEINRICH_DUNCUMB_REED, LOVE_SCOTT_I,
               LOVE_SCOTT_II, PACKWOOD_PHI_PZ, BASTIN_ORIGINAL_PHI_PZ, BASTIN_PROZA_PHI_PZ, POUCHOU_AND_PICHOIR_FULL, POUCHOU_AND_PICHOIR_SIMPLIFIED};
      }

      public static final CITZAFCorrectionAlgorithm ARMSTRONG_LOVE_SCOTT = new CITZAFCorrectionAlgorithm(new int[]{2, 1, 2, 0, 0, 9, 4, 4});

      public static final CITZAFCorrectionAlgorithm CONVENTIONAL_PHILIBERT_DUNCUMB_REED = new CITZAFCorrectionAlgorithm(
            new int[]{1, 2, 5, 0, 0, 1, 1, 1});

      public static final CITZAFCorrectionAlgorithm HEINRICH_DUNCUMB_REED = new CITZAFCorrectionAlgorithm(new int[]{1, 1, 5, 0, 0, 2, 1, 2});

      public static final CITZAFCorrectionAlgorithm LOVE_SCOTT_I = new CITZAFCorrectionAlgorithm(new int[]{2, 1, 2, 0, 0, 4, 4, 4});

      public static final CITZAFCorrectionAlgorithm LOVE_SCOTT_II = new CITZAFCorrectionAlgorithm(new int[]{2, 1, 2, 0, 0, 6, 4, 4});

      public static final CITZAFCorrectionAlgorithm PACKWOOD_PHI_PZ = new CITZAFCorrectionAlgorithm(new int[]{1, 5, 7, 0, 0, 14, 6, 0});

      public static final CITZAFCorrectionAlgorithm BASTIN_ORIGINAL_PHI_PZ = new CITZAFCorrectionAlgorithm(new int[]{2, 3, 2, 0, 0, 10, 6, 0});

      public static final CITZAFCorrectionAlgorithm BASTIN_PROZA_PHI_PZ = new CITZAFCorrectionAlgorithm(new int[]{3, 3, 4, 0, 0, 15, 5, 7});

      public static final CITZAFCorrectionAlgorithm POUCHOU_AND_PICHOIR_FULL = new CITZAFCorrectionAlgorithm(new int[]{3, 3, 4, 0, 0, 12, 5, 7});

      public static final CITZAFCorrectionAlgorithm POUCHOU_AND_PICHOIR_SIMPLIFIED = new CITZAFCorrectionAlgorithm(
            new int[]{3, 3, 4, 0, 0, 13, 5, 7});
   }
   ...
   public static String[] BACKSCATTER_COEFFICIENTS = {"Heinrich", "Love/Scott", "Pouchou & Pichoir", "Hunger & Kuchler<A&W-mod>", "None"};
   ...
   public static String[] MEAN_IONIZATION_POTENTIALS = {"Berger/Seltzer", "Duncumb/Da Casa", "Ruste/Zeller", "Springer", "Wilson", "Heinrich",
         "Bloch<Love/Scott>", "Armstrong<Springer/Berger>", "Joy <Wilson/Berger>"};
   ...
   public static String[] PHI_O_EQUATIONS = {"Reuter", "Love/Scott", "Riveros", "Pouchou & Pichoir", "Karduck & Rehbach", "August & Wernisch",
         "Packwood", "None"};
   ...
   public static String[] IONIZATION_CROSS_SECTIONS = {"Bethe<Powell>", "Bethe<Brown>", "Green & Cosslett", "Hutchins", "Fabre<Powell>",
         "Worthington & Tomlin", "Gryzinsky", "Casnati", "Jacobi", "Rez", "None"};
   ...
   public static String[] ELECTRON_RETARDATION_EQUATIONS = {"Bethe<Rao-Sahib/Wittry>", "Love & Scott", "Joy", "None"};
   ...
   public static String[] ABSORPTION_CORRECTIONS = {"Absorption correction of Philibert", "Absorption correction of Heinrich/An. chem",
         "Absorption correction of Heinrich/1989 MAS", "Absorption correction of Love/Scott - 1983", "Absorption correction of Love/Scott I - 1985",
         "Absorption correction of Love/Scott II - 1985", "PHI<PZ> Absorption correction of Packwood/Brown 1982/XRS",
         "PHI<PZ> Absorption correction of Bastin 1984/XRS", "PHI<PZ> Absorption correction of Armstrong<P/B> 1981/MAS",
         "PHI<PZ> Absorption correction of Bastin 1986/Scanning", "PHI<PZ> Absorption correction of Riveros 1987/XRS",
         "Absorption correction of Pouchou & Pichoir - Full PAP", "Absorption correction of Pouchou & Pichoir - Simple PAP",
         "PHI<PZ> Absorption correction of Packwood <EPQ-91>", "PHI<PZ> Absorption correction of Bastin PROZA <EPQ-91>"};
   ...
   public static String[] ATOMIC_NUMBER_STOPPING_POWERS_CORRECTIONS = {"Stopping power correction of Duncumb/Reed<Frame>",
         "Stopping power correction of Philibert & Tixier", "Stopping power correction by Numerical Integration",
         "Stopping power correction of Love & Scott", "Stopping power correction of Pouchou & Pichoir",
   ...
   public static String[] BACKSCATTER_CORRECTIONS = {"Duncumb/Reed<Frame-I>", "Duncumb/Reed<Frame-II>", "Duncumb/Reed<Heinrich-Mod>", "Love & Scott",
         "Myklebust - I", "Myklebust & Fiori (not implemented yet)", "Pouchou & Pichoir", "August, Razka & Wernisch", "Springer", "None"};
   ...
   public static class MassAbsorptionCoefficient {
      ...
      public static MassAbsorptionCoefficient[] getAllImplimentations() {
         return new MassAbsorptionCoefficient[]{MASS_ABSORPTION_COEFFICIENTS_FROM_DATA_TABLES,
               MASS_ABSORPTION_COEFFICIENTS_FROM_TABLES_AND_USER_ENTRY, MASS_ABSORPTION_COEFFICIENTS_FROM_HEINRICH_ICXOM_11_EQN,
      ...
      public static final MassAbsorptionCoefficient MASS_ABSORPTION_COEFFICIENTS_FROM_HEINRICH_ICXOM_11_AND_USER_ENTRY = new MassAbsorptionCoefficient(
            3);
   ...
   public static class ParticleModel {
      ...
      public static ParticleModel[] getAllImplimentations() {
         return new ParticleModel[]{PARTICLE_MODEL_OF_THIN_FILM_TPS, PARTICLE_MODEL_OF_RECTANGULAR_PRISM, PARTICLE_MODEL_OF_TETRAGONAL,
               PARTICLE_MODEL_OF_TRIGONAL_PRISM, PARTICLE_MODEL_OF_SQUARE_PYRAMID, PARTICLE_MODEL_OF_SIDE_SCATTER_MODIFIED_RECTANGULAR_PRISM};
      }
    ...
    */
   public class MAC implements Comparable<MAC> {
      public Element elm;
   ...
   public Map<Element, String> getElementToLineMap() {
      return mUsingKRatios
            ? new TreeMap<Element, String>(mElementToLineMapWithKRatios)
    ...
    *           String
    * @throws IllegalArgumentException
    *            (algorithm not in CITZAFAlgorithms)
    */
    ...
    * used in the analysis
    * 
    * @param UseStageCoordinates
    *           int
    * @throws IllegalArgumentException
    *            ((UseStageCoordinates != USE_STAGE_COORDINATES) &amp;&amp;
    *            (UseStageCoordinates != DO_NOT_USE_STAGE_COORDINATES))
    */
    ...
    *           int
    * @throws IllegalArgumentException
    *            ((PrintoutZAF != PRINTOUT_ZAF) &amp;&amp; (PrintoutZAF !=
    *            DO_NOT_PRINTOUT_ZAF))
    */
    ...
    * concentrations
    * 
    * @param MinorElementsConcentration
    *           int
    * @throws IllegalArgumentException
    ...
    *           Vector
    * @throws IllegalArgumentException
    *            (x is an element of models &amp;&amp; x is not a Particle
    *            model)
    */
    ...
    * sample during analysis
    * 
    * @param ParticleDiameters
    *           Vector
    * @throws IllegalArgumentException
    *            (x is an element of ParticleDiameters &amp;&amp; x &lt; 0)
    */
            ...
            try (final PrintWriter pw = new PrintWriter(os)) {
               ...
               if ((mMACAlgorithm == MassAbsorptionCoefficient.MASS_ABSORPTION_COEFFICIENTS_FROM_TABLES_AND_USER_ENTRY)
                  ...
                  for (final MAC mac : mMACs.keySet())
                     pw.println(
                           MasterElementSetIndexMap.get(mac.elm) + "," + MasterElementSetIndexMap.get(mac.xrt.getElement()) + "," + mMACs.get(mac));
                  pw.println("0");
               }
    ...
    * 
    * @throws IOException
    *            - if the Dataout file is in the wrong format(due to an error in
    *            writing the file) or the method fails to read correctly, this
    *            exception will be thrown
    * @return String
    */
   public String getCondensedResults() throws IOException {
