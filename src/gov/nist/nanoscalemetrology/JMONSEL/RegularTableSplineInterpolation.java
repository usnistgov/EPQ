...
public class RegularTableSplineInterpolation {
    ...
    * named resource. The table is assumed to be stored in the resource as
    * numbers (in character format) separated by white space. The numbers are in
    * this order: Number of input variables for this table (N), # of values
    * taken by the 1st input variable, minimum value of 1st input variable,
    * increment of 1st input variable, ... (repeated for 2nd, 3rd, up to Nth
    * input variable), then a list of the tabulated values in order with the Nth
