...
public class GasMixture
    ...
    * 
    * @param gases A list of constituent gases
    * @param temp The common temperature in kelvin
    * @param name The human friendly name for the gas
    */
   ...
   public static GasMixture createAir(double pressure, double temperature) {
      final Gas n2 = new Gas(new Element[] {
         Element.N
      }, new int[] {
         2
      }, 0.78084 * pressure, temperature, "N2");
      final Gas o2 = new Gas(new Element[] {
         Element.O
      }, new int[] {
         2
      }, 0.20947 * pressure, temperature, "O2");
      final Gas ar = new Gas(new Element[] {
         Element.Ar
      }, new int[] {
         1
      }, 0.00934 * pressure, temperature, "Ar");
      final Gas co2 = new Gas(new Element[] {
         Element.C,
         Element.O
      }, new int[] {
         1,
         2
      }, 0.00033 * pressure, temperature, "CO2");
      return new GasMixture(new Gas[] {
         n2,
         o2,
         ar,
         co2
