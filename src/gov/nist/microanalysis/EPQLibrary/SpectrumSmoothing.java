 ...
 * @version 1.0
 */
abstract public class SpectrumSmoothing
   extends AlgorithmClass
   implements ISpectrumTransformation {
   ...
   private static class SavitzkyGolay
      extends SpectrumSmoothing {

      private final int mM;

      private final double[][] Coefficients = new double[][] {
         new double[] {
            35,
            17,
            12,
      ...
      public SavitzkyGolay(int m) {
         super("Savitsky-Golay", new LitReference.JournalArticle(LitReference.AnalChem, "35", "1627", 1964, new Author[] {
            LitReference.Savitzky,
            LitReference.Golay
         }));
         mM = m;
      }
   ...
   public static class SavitzkyGolay2SpectrumSmoothing
      extends SavitzkyGolay {
      protected SavitzkyGolay2SpectrumSmoothing() {
         super(2);
      }
   }

   public static class SavitzkyGolay3SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay4SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay5SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay6SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay7SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay8SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay9SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay10SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay11SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class SavitzkyGolay12SpectrumSmoothing
      extends SavitzkyGolay {
   ...
   public static class NoSpectrumSmoothing
      extends SpectrumSmoothing {
